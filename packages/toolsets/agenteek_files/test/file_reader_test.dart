...
void main() {
  group('FileReader', () {
    test('utf16-be with BOM', () async {
      final file = File(
        await getWorkspacePath(
          'packages/toolsets/agenteek_files/test/assets/utf16be_bom.txt',
        ),
      );
    ...
    test('utf16-le with BOM', () async {
      final file = File(
        await getWorkspacePath(
          'packages/toolsets/agenteek_files/test/assets/utf16le_bom.txt',
        ),
      );
    ...
    test('utf8 with BOM', () async {
      final file = File(
        await getWorkspacePath(
          'packages/toolsets/agenteek_files/test/assets/utf8_bom.txt',
        ),
      );
    ...
    test('utf8 without BOM', () async {
      final file = File(
        await getWorkspacePath(
          'packages/toolsets/agenteek_files/test/assets/utf8.txt',
        ),
      );
      final contents = await file.readAsString(encoding: utf8);
      final text = await FileReader.readString(file);
    ...
    test('Windows1252', () async {
      final file = File(
        await getWorkspacePath(
          'packages/toolsets/agenteek_files/test/assets/cp1252.txt',
        ),
      );
